...
export default {
  ...
  mounted() {
    this.username = this.bloggerData.username;
    this.first_name = this.bloggerData.first_name;
    this.last_name = this.bloggerData.last_name;
    this.email = this.bloggerData.email;
    this.role = this.bloggerData.role;
  },
